...
summary: |
  Rebuilt API documentation to provide a clear path to first API call, using an OpenAPI-based reference and task-focused quickstart.audience: Backend and frontend developers integrating current weather data.
